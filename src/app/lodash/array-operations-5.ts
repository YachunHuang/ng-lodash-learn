  ...
  examples = [
    {
      ...
      tip: '就是「選定區域」，把它們換成你指定的內容。好像把某些數字換成字母。',
      demo: ''
    },
    {
    ...
    },
    {
      ...
      tip: '就是「一網打盡」，把所有出現的相同元素都抓出來，剩下的就留下來。',
      demo: ''
    },
    {
      ...
      tip: '跟 _.pullAll 相似，但這裡是讓你自己決定要根據什麼條件去挑選，像是找出有相同屬性的元素並刪掉',
      demo: ''
    },
    {
      title: '_.pullAllWith(array, values, [comparator])',
      desc: '使用自定義的比較函數來從陣列中移除所有匹配的元素，這樣可以根據你的比較方式來判斷。',
      code: '_.pullAllWith([1, 2, 3, 4], [2, 3], (a, b) => a === b)',
      result: _.pullAllWith([1, 2, 3, 4], [2, 3], (a, b) => a === b),
      tip: '你可以設計自己的比較邏輯，像是「兩個數字完全相等」才移除，這樣就能完全控制過濾條件。',
      demo: ''
    },
    {
      ...
      tip: '就是「指定位置」，將陣列中的元素直接抽取出來，剩下的再放回。',
      demo: ''
    }
  ];
}
